...
describe("BusinessControllerFileTypeUtils", () => {
	describe("allowedMimeTypes", () => {
		it("should return allowed MIME types for IDENTIFICATION_FRONT (no PDF)", () => {
			const result = BusinessControllerFileTypeUtils.allowedMimeTypes(BusinessControllerFileType.IDENTIFICATION_FRONT);
		...
		it("should return allowed MIME types for IDENTIFICATION_BACK (no PDF)", () => {
			const result = BusinessControllerFileTypeUtils.allowedMimeTypes(BusinessControllerFileType.IDENTIFICATION_BACK);
		...
		it("should return all allowed MIME types for PROOF_OF_ADDRESS (includes PDF)", () => {
			const result = BusinessControllerFileTypeUtils.allowedMimeTypes(BusinessControllerFileType.PROOF_OF_ADDRESS);
