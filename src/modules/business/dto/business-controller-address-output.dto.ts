...
export class BusinessControllerAddressOutputDto extends DatabaseOutputDto {
	static override fromDatabaseRow(row: BusinessControllerDatabaseRow): BusinessControllerAddressOutputDto {
		return {
